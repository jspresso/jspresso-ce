 ...
 */
public class MockResetPasswordAction extends AbstractResetPasswordAction {
   ...
   */
  @Override
  protected boolean changePassword(String username,
      String generatedPassword) {
    throw new ActionBusinessException(
        "Password has not actually been changed.", "password.not.changed");
  }

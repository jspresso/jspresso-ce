 ...
 */
package org.jspresso.framework.application.view.descriptor.mobile;

import org.jspresso.framework.application.model.Workspace;
import org.jspresso.framework.application.model.descriptor.WorkspaceDescriptor;
import org.jspresso.framework.application.view.descriptor.basic.BasicModuleViewDescriptor;
 ...
 * @internal
 */
public class MobileWorkspaceViewDescriptor extends MobileTreeViewDescriptor {

  /**
   * Constructs a new {@code MobileWorkspaceViewDescriptor} instance.
   */
  public MobileWorkspaceViewDescriptor() {

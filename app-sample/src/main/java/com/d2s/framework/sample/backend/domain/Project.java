...
public interface Project extends
   ...
   */
  void setProjectMembers(java.util.Set<com.d2s.framework.sample.backend.domain.Employee> projectMembers);
   ...
   */
  void addToProjectMembers(com.d2s.framework.sample.backend.domain.Employee projectMembersElement);
   ...
   */
  void removeFromProjectMembers(com.d2s.framework.sample.backend.domain.Employee projectMembersElement);

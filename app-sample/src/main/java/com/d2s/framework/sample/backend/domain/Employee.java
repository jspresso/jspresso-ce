 ...
 */
public interface Employee extends com.d2s.framework.sample.backend.domain.Person {
  ...
  void setManagedEmployees(
      java.util.Set<com.d2s.framework.sample.backend.domain.Employee> managedEmployees);
  ...
  void addToManagedEmployees(
      com.d2s.framework.sample.backend.domain.Employee managedEmployeesElement);
  ...
  void setEmployeeProjects(
      java.util.Set<com.d2s.framework.sample.backend.domain.Project> employeeProjects);
  ...
  void addToEmployeeProjects(
      com.d2s.framework.sample.backend.domain.Project employeeProjectsElement);

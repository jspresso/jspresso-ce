...
public interface Employee extends
   ...
   */
  void setManagedEmployees(java.util.Set<com.d2s.framework.sample.backend.domain.Employee> managedEmployees);
   ...
   */
  void addToManagedEmployees(com.d2s.framework.sample.backend.domain.Employee managedEmployeesElement);
   ...
   */
  void removeFromManagedEmployees(com.d2s.framework.sample.backend.domain.Employee managedEmployeesElement);
   ...
   */
  void setDepartment(com.d2s.framework.sample.backend.domain.Department department);
   ...
   */
  void setEmployeeProjects(java.util.Set<com.d2s.framework.sample.backend.domain.Project> employeeProjects);
   ...
   */
  void addToEmployeeProjects(com.d2s.framework.sample.backend.domain.Project employeeProjectsElement);
   ...
   */
  void removeFromEmployeeProjects(com.d2s.framework.sample.backend.domain.Project employeeProjectsElement);

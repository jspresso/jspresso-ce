...
public class BasicQueryComponentDescriptorFactory implements
  ...
  public BasicQueryComponentDescriptorFactory() {
    registry = new THashMap<IComponentDescriptorProvider<? extends IComponent>, IComponentDescriptor<IQueryComponent>>();
    refRegistry = new THashMap<Class<? extends IComponent>, IComponentDescriptor<? extends IComponent>>();
  }

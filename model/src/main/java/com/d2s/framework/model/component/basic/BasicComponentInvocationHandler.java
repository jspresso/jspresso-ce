 ...
 */
public class BasicComponentInvocationHandler implements InvocationHandler,
    Serializable {
  ...
  public synchronized Object invoke(Object proxy, Method method, Object[] args)
    ...
    if ("hashCode".equals(methodName)) {
      ...
      return new Boolean(computeEquals(proxy, args[0]));
  ...
  private int computeHashCode() {
    // TODO complete with hashcode of wrapped object
  ...
  private boolean computeEquals(Object proxy, Object another) {
    ...
    // TODO complete with equality of wrapped object
    if (Proxy.isProxyClass(another.getClass())
        && Proxy.getInvocationHandler(another) instanceof BasicComponentInvocationHandler) {
      // BasicComponentInvocationHandler otherInvocationHandler =
      // (BasicComponentInvocationHandler) Proxy
      // .getInvocationHandler(another);
      // Compare with handler wrapped object
    } else {
      // Compare with handler wrapped object
    }
    return false;

 ...
 * @hibernate.class table = "PERSON" dynamic-insert = "true" dynamic-update =
 *                  "true" persister =
 ...
 */
public interface Person extends com.d2s.framework.test.model.domain.Nameable,
   ...
   * @hibernate.column name = "BIRTH_CITY_ID"
   * @return the birthCity.
   */
  com.d2s.framework.test.model.domain.City getBirthCity();
   ...
   */
  void setBirthCity(com.d2s.framework.test.model.domain.City birthCity);

  /**
   * Gets the addressCity.
   * 
   * @hibernate.many-to-one cascade = "lock"
   * @hibernate.column name = "ADDRESS_CITY_ID"
   * @return the addressCity.
   */
  com.d2s.framework.test.model.domain.City getAddressCity();
   ...
   */
  void setAddressCity(com.d2s.framework.test.model.domain.City addressCity);
   ...
   * @hibernate.column name = "MARRIED_TO_ID" unique = "true"
   * @return the marriedTo.
   */
  com.d2s.framework.test.model.domain.Person getMarriedTo();
   ...
   */
  void setMarriedTo(com.d2s.framework.test.model.domain.Person marriedTo);

  /**
   * Gets the gender.
   * 
   * @hibernate.property
   * @hibernate.column name = "GENDER" not-null = "true"
   * @return the gender.
   */
   ...
   * 
   * @hibernate.property
   * @hibernate.column name = "VEGETARIAN"

package org.jspresso.framework.util
{
  ...
  public class SimpleDateFormatter {
  	...
  	private static var MONTH_NAMES:Array = new Array('January','February','March','April','May','June','July','August','September','October','November','December','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec');
  	private static var DAY_NAMES:Array = new Array('Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sun','Mon','Tue','Wed','Thu','Fri','Sat');

  	private static function LZ(x:int):String {
  	  return(x<0||x>9?"":"0")+x;
  	}

 ...
 */
public class MobileEvenGridViewDescriptor extends BasicEvenGridViewDescriptor
  ...
  /**
   * Instantiates a new Mobile even grid view descriptor.
   */
  public MobileEvenGridViewDescriptor() {

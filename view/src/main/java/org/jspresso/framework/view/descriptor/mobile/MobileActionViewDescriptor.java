 ...
 */
public class MobileActionViewDescriptor extends BasicActionViewDescriptor
  ...
  /**
   * Instantiates a new Mobile action view descriptor.
   */
  public MobileActionViewDescriptor() {

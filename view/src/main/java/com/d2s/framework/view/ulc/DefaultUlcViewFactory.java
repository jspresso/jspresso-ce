...
import com.d2s.framework.binding.ui.ulc.CollectionConnectorListModel;
import com.d2s.framework.binding.ui.ulc.CollectionConnectorTableModel;
import com.d2s.framework.binding.ui.ulc.ConnectorHierarchyTreeModel;
import com.d2s.framework.binding.ui.ulc.ConnectorTreeHelper;
import com.d2s.framework.binding.ui.ulc.IListSelectionModelBinder;
import com.d2s.framework.binding.ui.ulc.ITreeSelectionModelBinder;
import com.d2s.framework.binding.ui.ulc.ULCActionFieldConnector;
import com.d2s.framework.binding.ui.ulc.ULCComboBoxConnector;
import com.d2s.framework.binding.ui.ulc.ULCDateFieldConnector;
...
public class DefaultUlcViewFactory implements IViewFactory<ULCComponent> {
  ...
  private ULCPopupMenu createULCPopupMenu(ULCComponent sourceComponent,
    ...
    titleLabel.setText(labelTranslator.getTranslation(

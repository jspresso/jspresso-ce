 ...
 * @internal
 */
public class NotEmptyCollectionSelectionTrackingGate extends
   ...
   * empty => open).
   */
  public static final NotEmptyCollectionSelectionTrackingGate INSTANCE = new NotEmptyCollectionSelectionTrackingGate();

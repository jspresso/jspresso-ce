...
public final class PropertyNameTank {
  ...
  private static final ConcurrentHashMap<String, Integer> TANK = new ConcurrentHashMap<String, Integer>();
  private static final ConcurrentHashMap<Integer, String> KNAT = new ConcurrentHashMap<Integer, String>();

...
public interface ISelectionChangeListener {
   ...
   *          <code>source</code> set to the selectable which initiated the
   *          event. <li><code>oldSelection</code> set to the old selection. <li>
   *          <code>newSelection</code> set to the new selection.
   */

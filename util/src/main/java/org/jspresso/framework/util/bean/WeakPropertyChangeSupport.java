...
public class WeakPropertyChangeSupport implements Serializable {
  ...
  protected Collection<WeakEntry<PropertyChangeListener>> createListenersCollection() {
    return new ArrayList<WeakEntry<PropertyChangeListener>>(1);
  }
  ...
  public synchronized void addPropertyChangeListener(String propertyName, PropertyChangeListener listener) {
    if (children == null) {
      children = new THashMap<String, WeakPropertyChangeSupport>(1, 1.0f);
    }
  ...
  public void firePropertyChange(String propertyName, Object oldValue,
    ...
    synchronized (this) {
      if (listeners != null) {
        targets = new ArrayList<WeakEntry<PropertyChangeListener>>(listeners);
      }

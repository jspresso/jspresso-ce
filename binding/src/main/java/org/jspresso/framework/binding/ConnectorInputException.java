...
/**
 * This exception is thrown whenever an exception occurs when directly setting
 ...
 */
public class ConnectorInputException extends NestedRuntimeException {
   ...
   */
  public ConnectorInputException(Throwable nestedException) {
   ...
   */
  public ConnectorInputException(Throwable nestedException, String message) {

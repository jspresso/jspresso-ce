...
<#macro generateClassHeader componentDescriptor>
  ...
  <#local isEntity=instanceof(componentDescriptor, "com.d2s.corelayer.model.descriptor.entity.IEntityDescriptor")/>
/*
 ...
 * 
  <#if isEntity>
 * @hibernate.mapping
 *                    default-access = "com.d2s.corelayer.model.persistence.hibernate.property.EntityPropertyAccessor"
 *                    package = "${package}"
 * @hibernate.class 
 *                  table = "${generateSQLName(componentName)}"
 *                  dynamic-insert = "true"
 *                  dynamic-update = "true"
 *                  persister = "com.d2s.corelayer.model.persistence.hibernate.entity.persister.EntityProxySingleTableEntityPersister"
  </#if>
...
<#macro generateScalarGetter componentDescriptor propertyDescriptor>
   ...
   * @hibernate.property
     <#if instanceof(propertyDescriptor, "com.d2s.corelayer.model.descriptor.IDatePropertyDescriptor")>
   ...
   *                   name = "${generateSQLName(propertyName)}"
     <#if instanceof(propertyDescriptor, "com.d2s.corelayer.model.descriptor.IStringPropertyDescriptor")
   ...
   *                   unique-key = "${generateSQLName(propertyDescriptor.unicityScope)}_UNQ"
     ...
     <#if instanceof(propertyDescriptor, "com.d2s.corelayer.model.descriptor.INumberPropertyDescriptor")>
   ...
   *                   scale = "10"
       ...
       <#if instanceof(propertyDescriptor, "com.d2s.corelayer.model.descriptor.IDecimalPropertyDescriptor")>
...
<#macro generateCollectionGetter componentDescriptor propertyDescriptor>
  ...
  <#if propertyDescriptor.reverseRelationEnd?exists>
    ...
    <#local manyToMany=instanceof(propertyDescriptor.reverseRelationEnd, "com.d2s.corelayer.model.descriptor.ICollectionPropertyDescriptor")>
    <#local componentName=componentDescriptor.name[componentDescriptor.name?last_index_of(".")+1..]/>
...
<#macro generateEntityRefGetter componentDescriptor propertyDescriptor>
  ...
  <#if propertyDescriptor.reverseRelationEnd?exists>
    ...
    <#assign oneToOne=instanceof(propertyDescriptor.reverseRelationEnd, "com.d2s.corelayer.model.descriptor.IReferencePropertyDescriptor")>
  <#else>
...
<#macro generatePropertyAccessors componentDescriptor propertyDescriptor>
  <#if instanceof(propertyDescriptor, "com.d2s.corelayer.model.descriptor.ICollectionPropertyDescriptor")>
    <@generateCollectionPropertyAccessors componentDescriptor=componentDescriptor propertyDescriptor=propertyDescriptor/>
  <#elseif instanceof(propertyDescriptor, "com.d2s.corelayer.model.descriptor.IReferencePropertyDescriptor")>

 ...
 */
public class JTriStateCheckBoxConnector extends JToggleButtonConnector {
   ...
   */
  @Override
  protected JTriStateCheckBox getConnectedJComponent() {
    return (JTriStateCheckBox) super.getConnectedJComponent();
  }
}
